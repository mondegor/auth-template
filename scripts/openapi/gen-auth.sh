...
mrcmd_func_openapi_gen_auth() {
  ...
  #echo -e "\n" >> "${destFilePath}"
  openapi_lib_add_string_to_end_file "${serviceSrc}/components-headers.yaml" "${destFilePath}" 4
  ...
  echo -e "\n" >> "${destFilePath}"
  openapi_lib_add_string_to_end_file "${serviceSrc}/components-schemas-Account.yaml" "${destFilePath}" 4
  echo -e "\n" >> "${destFilePath}"
  openapi_lib_add_string_to_end_file "${serviceSrc}/components-schemas-CreateAccount.yaml" "${destFilePath}" 4
  echo -e "\n" >> "${destFilePath}"
  openapi_lib_add_string_to_end_file "${serviceSrc}/components-schemas-AuthAccount.yaml" "${destFilePath}" 4
  echo -e "\n" >> "${destFilePath}"
  openapi_lib_add_string_to_end_file "${serviceSrc}/components-schemas-AccessAccount.yaml" "${destFilePath}" 4
